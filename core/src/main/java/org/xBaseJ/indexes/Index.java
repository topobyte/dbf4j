...
public abstract class Index
{
			...
			throws xBaseJException, IOException
	{
		...
		if (keyType == 'F') {
			tempKey = new NodeKey(
					new NodeFloat(Double.valueOf(keyToCompare).doubleValue()));
		} else if (keyType == 'N') {
	...
	{
		if (keyType == 'F') {
			return find_entry(new NodeKey(
					new NodeFloat(Double.valueOf(key).doubleValue())));
		}
	...
	public int find_entry(String key, int recno)
			throws xBaseJException, IOException
	{
